#!/usr/bin/env bash
# II r17 GLM runner: derived from run-glm52-exl3-tp4-node.sh but
...
# images use THIS file, and the r17 build gates assert the four are
...
IMAGE=${IMAGE:-localhost/voipmonitor/vllm:infernal-invocation-r17-spark-sm121-vllme879345-b12xc0a44a1-fi1ac6942-cu133-torch213-20260818b}
