...
Encoder correctness is NOT required here: quantize_tiles supplies valid
tail-biting trellis data regardless of its (known fork-wide inconsistent)
reported reconstructions; both compared paths decode the same bits.
"""
import importlib
import sys
import types
