...
# Infernal Invocation model-family dispatcher (II r18-spark, 2026-08-18).
# OWNS II dispatch directly - the legacy delegation to the GG unified
# dispatcher (serve-gilded-gnosis.sh) is severed: II images do not ship
# that launcher, and the four GG EXL3 tuning exports it carried are
# omitted here unconditionally (the r10 lesson: they collapsed II
# mixed-Trellis prefill). GG images keep their own launcher on the GG
# release branches; there is no runtime profile switch.
