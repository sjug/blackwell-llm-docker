...
# TP4 preset for madeby561's mixed NVFP4/NF3 checkpoint. The named online
# overlay reproduces its published MXFP8 dense/shared-expert tier exactly.
...
export ONLINE_QUANT="${ONLINE_QUANT:-nf3-mxfp8}"
export NF3_GRID188="${NF3_GRID188:-1}"
