...
#   vLLM       92b27a47a0d25ff2ff406eb9c8d464ef7ed002cf (r24 f5981f14 + SM121)
...
release_dir="patches/releases/gilded-gnosis-v20p3-spark-r24"
...
export IMAGE="${IMAGE:-voipmonitor/vllm:gilded-gnosis-v20p3-spark-sm121-vllm${VLLM_INTEGRATION_TREE:0:7}-si${SPARKINFER_INTEGRATION_TREE:0:7}-fi7ad08da-cu132-${DATE_TAG}}"
export VLLM_BUILD_VERSION="${VLLM_BUILD_VERSION:-0.11.2.dev280+gilded.gnosis.v20p3.spark.vllm${VLLM_INTEGRATION_TREE:0:7}.si${SPARKINFER_INTEGRATION_TREE:0:7}.fi7ad08da.sm121.cu132.${DATE_TAG}}"
